...
syn region pandocLaTeXMathBlock matchgroup=texMathDelimZone start=/\$\$/ end=/\$\$/ keepend contains=@texClusterMath
syn region pandocLaTeXMathBlock matchgroup=texMathDelimZone start=/\\\@<!\\\[/ end=/\\\@<!\\\]/ keepend contains=@texClusterMath
...
hi link pandocLatexInlineMath texMathZone
hi link pandocLaTeXMathBlock texMathZone
